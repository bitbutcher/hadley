...
4. Add warden and hadley to your middleware stack by opening <tt>config/initializers/hadlery.rb</tt> in your favorite
text editor and adding the following:
...
5. Run <tt>rake middleware</tt> from your project root and verify that 
